            ...
            function baseDerangement(baseexcess) {
                if (baseexcess > 3) {
                    summation_processes.push(`The positive base excess indicates a metabolic alkalosis`);
                }
                else if (baseexcess < -3) {
                    summation_processes.push(`The negative base excess indicates a metabolic acidosis`);
                }
            ...
            function calculateUnmeasured(sodium, potassium, chloride, baseexcess, lactate_effect, albumin_effect) {
                ...
                summation_processes.push(`Sum Effect: ${sum_effect} [${chloride_effect} - ${lactate_effect} + ${albumin_effect}]`);
                if (unmeasured < 0) {
                    summation_processes.push(`As Measured Base Effect: ${baseexcess}, and Sum Effect: ${sum_effect}, ${unmeasured} is unaccounted for.`)
                    summation_processes.push("This indicates another metabolic acidosis is occurring, likely explained by unmeasured ions.");
